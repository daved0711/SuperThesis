...
class TransactionController extends Controller
{
    ...
    public function getTop10BrangayBaseMonthYear(Request $request): JsonResponse
    {
        $monthYear = $request->input("monthYear");
        $start = "$monthYear-01";
    ...
    public function getGenderCountBranch(Request $request): JsonResponse
    {
        $monthYear = $request->input("monthYear");
        $start = "$monthYear-01";
        $end = date('Y-m-d', strtotime("$start +1 month"));
        $analyticService = new AnalyticService();
        return response()->json($analyticService->getGenderCountBranch($start, $end));
    }

    public function getAgeCountBranch(Request $request): JsonResponse
    {
        $monthYear = $request->input("monthYear");
        $start = "$monthYear-01";
        $end = date('Y-m-d', strtotime("$start +1 month"));
        $analyticService = new AnalyticService();
        return response()->json($analyticService->getAgeCountBranch($start, $end));
    }

    public function getCategoryCountBranch(Request $request): JsonResponse
    {
        $monthYear = $request->input("monthYear");
        $start = "$monthYear-01";
        $end = date('Y-m-d', strtotime("$start +1 month"));
        $analyticService = new AnalyticService();
        return response()->json($analyticService->getCategoryCountBranch($start, $end));
    }
}
