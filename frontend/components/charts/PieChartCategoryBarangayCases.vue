...
const { getCategoryCountBranch } = useTransactionService();
const {data: transactions, loading, execute} = getCategoryCountBranch({immediate: false});
...
<template>
  ...
  <div class="w-[50%] mt-5 rounded-2xl shadow-sm p-6 border border-gray-200">
    <h2 class="font-bold">No of Category Cases per Barangay</h2>
